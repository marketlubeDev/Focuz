    ...
    <div className="service">
      <div className="service__container">
        <div className="service__container__main">
          <h2 className="service__container__main__title">Rooms and Suits</h2>
          <div className="service__container__main__content">
            ...
            <p className="service__container__main__content__description">
              Focuz Habitat offers a range of rooms and suites, including the
              Deluxe Suite, Two-Bedroom Suite, and Three-Bedroom Family Suite.
              All accommodations come with modern amenities such as free Wi-Fi,
              air conditioning, and in-room dining for a comfortable stay.
            </p>
          </div>
        </div>
